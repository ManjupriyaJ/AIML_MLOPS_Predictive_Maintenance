...
Xtrain_path = "hf://datasets/ManjupriyaJ/Predictive-Maintenance/Xtrain.csv"
Xtest_path = "hf://datasets/ManjupriyaJ/Predictive-Maintenance/Xtest.csv"
ytrain_path = "hf://datasets/ManjupriyaJ/Predictive-Maintenance/ytrain.csv"
ytest_path = "hf://datasets/ManjupriyaJ/Predictive-Maintenance/ytest.csv"

Xtrain = pd.read_csv(Xtrain_path)
Xtest = pd.read_csv(Xtest_path)
ytrain = pd.read_csv(ytrain_path).squeeze()  # converts DataFrame to Series
ytest = pd.read_csv(ytest_path).squeeze()    # same here
...
with mlflow.start_run():
   ...
   repo_id = "ManjupriyaJ/Predictive-Maintenance"
   repo_type = "model"
